# Leçon 12 — Responsive Design et Media Queries
...
## 2. La balise `<meta viewport>` — Obligatoire !
...
## 6. Adapter Flexbox et Grid avec les Media Queries
...
## 7. Navigation hamburger (menu mobile)
